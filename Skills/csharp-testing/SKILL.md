---
name: csharp-testing
description: "C# unit testing conventions: xUnit, FakeItEasy (A.Dummy vs A.Fake), FluentAssertions, AutoFixture, Arrange/Act/Assert blocks, naming Действие_Условие_ОжидаемыйРезультат, systemUnderTests field, Path.Join for paths. Use when writing or editing C# test classes and unit tests."
---
